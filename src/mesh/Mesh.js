...
import { yawPitchRollToMat4, mat4ToYawPitchRoll } from 'math3d/yawPitchRoll';
...
class Mesh {
  ...
  updateYawPitchRollFromMatrix() {
    mat4ToYawPitchRoll(this._transformData._yawPitchRoll, this._transformData._matrix);
  }
