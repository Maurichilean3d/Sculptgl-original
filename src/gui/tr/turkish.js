var TR = {
  ...
  modelingSidebarTitle: 'Modeling',
  modelingSelectionTitle: 'Selection',
  modelingSelectionMode: 'Element',
  modelingSelectionAction: 'Action',
  modelingToolsTitle: 'Modeling tools',
  modelingExtrude: 'Extrude',
  modelingDelete: 'Delete',
  modelingFill: 'Fill',
  modelingBridge: 'Bridge',
  modelingKnife: 'Knife',
  modelingLoopCut: 'Loop cut',
  modelingNotImplemented: 'This modeling tool is not implemented yet.',
  sculptRotomoldTitle: 'Rotomolding',
  sculptRotomoldEnable: 'Enable rotomolding',
  sculptRotomoldSpeed: 'Rotation speed (deg/s)',
  sculptRotomoldAxis: 'Rotation axis',
  sculptRotomoldAxisX: 'X',
  sculptRotomoldAxisY: 'Y',
  sculptRotomoldAxisZ: 'Z',
  sculptRotomoldPivot: 'Rotation pivot',
  sculptRotomoldPivotMesh: 'Mesh center',
  sculptRotomoldPivotWorld: 'World origin',
  sculptGizmoTransform: 'Gizmo',
  sculptCoordSpace: 'Koordinat alanı',
  sculptGlobal: 'Küresel',
  sculptLocal: 'Yerel',
  sculptLocalTransform: 'Sapma/Yunuslama/Yalpalama',
  sculptYaw: 'Sapma',
  sculptPitch: 'Yunuslama',
  sculptRoll: 'Yalpalama',
